        ...
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                    ...
                    <div className="relative mt-1">
                        <input
                            ...
                            className="block w-full rounded-xl bg-gray-50 border-gray-200 shadow-sm focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all p-3 pr-10 border text-sm"
                ...
                <button
                    ...
                    className="w-full py-3 px-4 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 active:scale-[0.98] shadow-lg shadow-indigo-200 transition-all disabled:opacity-50"
                >
